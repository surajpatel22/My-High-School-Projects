...
fcn StartGame_or_Instructions : string (1)   % at the start menu, the player has to choose to start or go to the inctructions, so this functions lets the main code know what option the user picked
...
process direction   % get the direction the ship spawns
    loop     
...
proc draw (animation : string, xpos, ypos : int)   %draws the graphics for the moves made
